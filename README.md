...
The hosted `font-loader.js` reads its own query parameters, adds a Google Fonts `<link>`, injects a font override `<style>` tag, and reapplies the font variables if Home Assistant updates the root style later.
